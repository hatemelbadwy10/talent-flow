...
import 'package:talent_flow/features/auth/page/register.dart';
import 'package:talent_flow/features/new_projects/page/add_offer_screen.dart';
...
import '../features/auth/page/change_password.dart';
import '../features/auth/page/confrim_code.dart';
import '../features/auth/page/login.dart';
import '../features/auth/page/send_verification.dart';
...
abstract class CustomNavigator {
    ...
    switch (settings.name) {
      ...
      case Routes.onBoarding:
        ...
        case Routes.freeLancer:
          return _pageRoute(const UserTypeSelectionScreen());
      case Routes.navBar:
  ...
  static _pageRoute(Widget child) =>
      Platform.isIOS ? CupertinoPageRoute(builder: (_) => child) : MaterialPageRoute(builder: (_) => child);
